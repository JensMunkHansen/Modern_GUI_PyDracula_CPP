...
void App::SetupUI()
{
  ...
  connect(this->ui->toggleButton, &QPushButton::clicked,
    [this]() { UIFunctions::toggleMenu(this, true); });
  ...
  // LEFT MENUS
  connect(widgets->btn_home, &QPushButton::clicked, this, &App::buttonClick);
  connect(widgets->btn_widgets, &QPushButton::clicked, this, &App::buttonClick);
  connect(widgets->btn_new, &QPushButton::clicked, this, &App::buttonClick);
  connect(widgets->btn_save, &QPushButton::clicked, this, &App::buttonClick);

  connect(widgets->toggleLeftBox, &QPushButton::clicked, this, &App::openCloseLeftBox);

  connect(widgets->extraCloseColumnBtn, &QPushButton::clicked, this, &App::openCloseLeftBox);

  connect(widgets->settingsTopBtn, &QPushButton::clicked, this, &App::openCloseRightBox);

  QObject::connect(widgets->btn_exit, &QPushButton::clicked, this, []() { qApp->exit(); });

  QString bg("#777");
  QString circle("#DDD");
  //  QString active("#00BCFF");
  QString active("#FF79C6");
  this->toggleWidget = new Toggle(this, 60, bg, circle, active);
  ...
  if (useCustomTheme)
  {
    ...
    UIFunctions::theme(this, themeFileWithPath, true);
    // SET HACKS
