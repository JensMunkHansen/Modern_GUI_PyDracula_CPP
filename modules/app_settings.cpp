...
std::string Settings::BTN_LEFT_BOX_COLOR = "background-color: rgb(44, 49, 58);";
std::string Settings::BTN_RIGHT_BOX_COLOR = "background-color: #ff79c6;";

std::string Settings::MENU_SELECTED_STYLESHEET = ""
